...
- Cree un proyecto de Angular con ng: `ng new safwebapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`safwebapp.client.esproj`).
